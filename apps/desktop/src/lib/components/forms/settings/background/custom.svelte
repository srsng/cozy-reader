                ...
                <Card.Action>
                    {#if hasThemeBinding($currentSettings.background.images[activeImageIndex])}
                        <Button
                            ...
                            onclick={() =>
                                removeThemeBinding(
                                    $currentSettings.background.images[activeImageIndex].id
                                )}
                        >
                            <RotateCcw />
                        </Button>
                                    ...
                                    <span class="text-sm">
                                        {AppThemeType2Str[
                                            ($currentSettings.background.images[activeImageIndex]
                                                .themeBinding?.type as AppThemeType) ||
                                                $currentSettings.theme.type
                                        ]}
                                    </span>
                                </div>
                                {#if $currentSettings.background.images[activeImageIndex].themeBinding?.type === 'four_colors'}
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-sm"
                                            >{(
                                                $currentSettings.background.images[activeImageIndex]
                                                    .themeBinding?.data as FourColorsThemeData
                                            )?.hue || 0}°</span
                                        >
                                    </div>
                                {:else if $currentSettings.background.images[activeImageIndex].themeBinding?.type === 'standard'}
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-sm"
                                            >{(
                                                $currentSettings.background.images[activeImageIndex]
                                                    .themeBinding?.data as StandardThemeData
                                            )?.name || 'default'}</span
                                        >
                                    </div>
                                {:else if $currentSettings.background.images[activeImageIndex].themeBinding?.type === 'pony'}
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-sm"
                                            >{(
                                                $currentSettings.background.images[activeImageIndex]
                                                    .themeBinding?.data as PonyThemeData
                        ...
                        <div class="bg-muted rounded-lg p-4">
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm"
                                        >{AppThemeType2Str[$currentSettings.theme.type]}</span
                                    >
                                </div>
                                {#if $currentSettings.theme.type === 'four_colors'}
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm font-medium">色相值:</span>
                                        <span class="text-sm"
                                            >{$currentSettings.theme.data.four_colors.hue}°</span
                                        >
                                    </div>
                                {:else if $currentSettings.theme.type === 'standard'}
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm font-medium">主题名称:</span>
                                        <span class="text-sm"
                                            >{$currentSettings.theme.data.standard.name}</span
                                        >
                                    </div>
                                {:else if $currentSettings.theme.type === 'pony'}
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm font-medium">角色名称:</span>
                                        <span class="text-sm"
                                            >{$currentSettings.theme.data.pony.name}</span
                                        >
                                    </div>
                                {/if}
                            </div>
            ...
            <Card.Header>
                ...
                <Card.Action>
                    <div class="flex items-center gap-2">
                        <Switch
                            checked={$currentSettings.background.images[activeImageIndex]
                                .enableConfig}
            ...
            <Card.Content class="space-y-4">
                {#if $currentSettings.background.images[activeImageIndex].config && $currentSettings.background.images[activeImageIndex].enableConfig}
                    ...
                    <div class="space-y-3">
                        ...
                        <Card.ContentItem
                            label="亮色模式不透明度"
                            description="调整亮色主题下的图片不透明度: 0~100%"
                        >
                            <SliderWithControls
                                bind:value={
                                    $currentSettings.background.images[activeImageIndex].config
                                        .opacity.light
                                }
                        ...
                        <Card.ContentItem
                            label="暗色模式不透明度"
                            description="调整暗色主题下的图片不透明度: 0~100%"
                        >
                            <SliderWithControls
                                bind:value={
                                    $currentSettings.background.images[activeImageIndex].config
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <Switch
                                checked={$currentSettings.background.images[activeImageIndex].config
                                    ?.filters !== undefined}
                                onCheckedChange={(checked) => {
                                    if (checked) {
                                    ...
                                    {#snippet valueLabel()}
                                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                            {Math.round(
                                                ($currentSettings.background.images[
                                                    activeImageIndex
                                                ].config?.filters?.grayscale || 0) * 100
                                            )}%
                                        </span>
                                    {/snippet}
                                </SliderWithControls>
                    ...
                    <div class="space-y-4">
                        ...
                        <Card.ContentItem
                            label="X轴偏移"
                            description="调整图片水平偏移: -1000~1000px"
                        >
                            <SliderWithControls
                                bind:value={
                                    $currentSettings.background.images[activeImageIndex].config
                        ...
                        <Card.ContentItem
                            label="Y轴偏移"
                            description="调整图片垂直偏移: -1000~1000px"
                        >
                            <SliderWithControls
                                bind:value={
                                    $currentSettings.background.images[activeImageIndex].config
