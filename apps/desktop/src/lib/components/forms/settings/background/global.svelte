                ...
                <Card.ContentItem label="亮度" description="调整亮度: 0~200%">
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.filters.brightness * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
                ...
                <Card.ContentItem label="对比度" description="调整对比度: 0~2">
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.filters.contrast * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
                ...
                <Card.ContentItem label="饱和度" description="调整饱和度: 0~2">
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.filters.saturate * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
                ...
                <Card.ContentItem label="灰度" description="调整灰度程度: 0~100%">
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.filters.grayscale * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
                ...
                <Card.ContentItem label="反转" description="调整反转程度: 0~100%">
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.filters.invert * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
