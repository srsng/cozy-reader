        ...
        <Card.Content class="space-y-4">
            ...
            <Card.ContentItem label="遮罩颜色" description="选择遮罩层的颜色">
                ...
                <Button
                    ...
                    size="icon"
                    onclick={() =>
                        ($currentSettings.background.global.backgroundOverlay.color = '#000000')}
                >
                    <RotateCcw />
                </Button>
            </Card.ContentItem>
            ...
            <div class="space-y-3">
                ...
                >
                    <SliderWithControls
                        bind:value={
                            $currentSettings.background.global.backgroundOverlay.opacity.light
                        }
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.backgroundOverlay.opacity
                                        .light * 100
                                )}%
                            </span>
                        {/snippet}
                ...
                >
                    <SliderWithControls
                        bind:value={
                            $currentSettings.background.global.backgroundOverlay.opacity.dark
                        }
        ...
        <Card.Content class="space-y-4">
            ...
            <Card.ContentItem label="遮罩颜色" description="选择遮罩层的颜色">
                ...
                <Button
                    ...
                    size="icon"
                    onclick={() =>
                        ($currentSettings.background.global.topOverlay.color = '#000000')}
                >
                    <RotateCcw />
                </Button>
            </Card.ContentItem>
                ...
                >
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.topOverlay.opacity.light *
                                        100
                                )}%
                            </span>
                        {/snippet}
                ...
                >
                    ...
                    >
                        {#snippet valueLabel()}
                            <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                                {Math.round(
                                    $currentSettings.background.global.topOverlay.opacity.dark * 100
                                )}%
                            </span>
                        {/snippet}
                    </SliderWithControls>
            ...
            <Card.ContentItem label="亮度" description="调整亮度: 0~200%">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.brightness *
                                    100
                            )}%
                        </span>
                    {/snippet}
            ...
            <Card.ContentItem label="对比度" description="调整对比度: 0~200%">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.contrast * 100
                            )}%
                        </span>
                    {/snippet}
                </SliderWithControls>
            ...
            <Card.ContentItem label="饱和度" description="调整饱和度: 0~200%">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.saturate * 100
                            )}%
                        </span>
                    {/snippet}
                </SliderWithControls>
            ...
            <Card.ContentItem label="模糊" description="调整模糊程度: 0~20px">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {$currentSettings.background.global.topOverlay.filters.blur.toFixed(
                                1
                            )}px
                        </span>
                    {/snippet}
            ...
            <Card.ContentItem label="灰度" description="调整灰度程度: 0~100%">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.grayscale *
                                    100
                            )}%
                        </span>
                    {/snippet}
            ...
            <Card.ContentItem label="色相旋转" description="调整色相旋转角度: 0~360°">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.hueRotate
                            )}°
                        </span>
                    {/snippet}
                </SliderWithControls>
            ...
            <Card.ContentItem label="反转" description="调整反转程度: 0~100%">
                ...
                >
                    {#snippet valueLabel()}
                        <span class="text-muted-foreground ml-4 w-12 pr-2 text-sm">
                            {Math.round(
                                $currentSettings.background.global.topOverlay.filters.invert * 100
                            )}%
                        </span>
                    {/snippet}
                </SliderWithControls>
