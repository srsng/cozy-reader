    ...
    export const buttonVariants = tv({
        ...
        variants: {
            variant: {
                ...
                warnDestructive: 'hover:bg-destructive hover:text-destructive-foreground',
                outline:
                ...
                bar: 'bg-card text-card-foreground hover:bg-accent-foreground/20',
                'bar-no-bg': 'text-card-foreground hover:bg-accent-foreground/20'
            },
            size: {
                default:
