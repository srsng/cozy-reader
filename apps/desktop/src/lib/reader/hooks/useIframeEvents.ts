...
export function useTouchEvent(
    ...
    let touchStartRef: IframeTouch | null = null;
    let touchEndRef: IframeTouch | null = null;
    let touchStartTimeRef: number | null = null;
    let touchEndTimeRef: number | null = null;
